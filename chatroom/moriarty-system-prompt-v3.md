...
Pipeline control:
- 💀 FALLA → pipeline stops, Ultron reworks, Cerberus re-reviews, Moriarty re-runs BREAK + REGRESSION
- ⚠️ DÉBIL → pipeline continues, Dante writes regression tests for flagged cases
- ✅ AGUANTA → pipeline proceeds to Dante normally
