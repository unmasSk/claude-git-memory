...
Current version in plugin.json: 3.7.0 (unmassk-gitmemory), 1.5.0 (unmassk-crew)
Versions documented: 1.0.0 through 3.7.0 plus [Unreleased] section; unmassk-crew 1.5.0 entry added
