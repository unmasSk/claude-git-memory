...
- [anti-patterns.md](anti-patterns.md) — Recurring shell anti-patterns found in ops-containers scripts (set -e without -u, source activate, unquoted trap, bash shebang)
